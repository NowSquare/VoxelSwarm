...
If the problem is in VoxelSite itself (the AI builder, not VoxelSwarm), report it to the [VoxelSite project](https://github.com/NowSquare/VoxelSite/issues) or see [voxelsite.com](https://voxelsite.com).
